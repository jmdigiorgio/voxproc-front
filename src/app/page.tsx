...
export default function HomePage() {
  return (
    <div className="flex flex-col items-center px-4 font-mono">
      <div className="pt-6 pb-8 md:pb-12 text-center">
        <div className="mb-12 md:mb-24 relative">
          <div className="absolute inset-0 -z-10 flex items-center justify-center w-screen left-1/2 -translate-x-1/2">
            <div className="flex gap-[1px] md:gap-[2px] min-w-screen overflow-hidden relative">
              ...
              {[...Array(128)].map((_, i) => (
                <div
                  key={i}
                  className={`w-1 md:w-2 h-48 md:h-96 bg-neutral-900 rounded-full origin-center opacity-[0.075] ${
                    i % 3 === 0
                      ? 'animate-wave-1'
                      : i % 3 === 1
                        ? 'animate-wave-2'
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-neutral-900 mb-4 md:mb-6 relative">
            Enough doomscrolling 😵
          </h1>
          <p className="text-lg md:text-xl text-neutral-800 max-w-2xl mx-auto px-4">
            Transform your social media into audio. Use your free time for more
            important things.
          </p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 max-w-7xl mx-auto mb-12 md:mb-24 animate-fade-in px-2">
        ...
        <div className="flex flex-col gap-4 items-center px-4">
          <Button
            asChild
            size="lg"
            className="bg-neutral-900 hover:bg-neutral-800 text-white transition-transform hover:scale-105 w-full sm:w-auto"
          >
            <Link href="/login">
          ...
          <Button
            ...
            size="lg"
            variant="outline"
            className="border-2 border-neutral-900 transition-transform hover:scale-105 w-full sm:w-auto"
          >
